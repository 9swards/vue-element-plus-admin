<template>
  <div class="layout flex h-screen">
    <div
      class="layout-sidebar-mask fixed w-screen h-screen bg-gray-500 bg-opacity-25 z-10"
      :class="{ hidden: menubar.status !== 2 }"
      @click="changeCollapsed"
    />
    <div
      class="layout-sidebar flex flex-col bg-menubar h-screen transitiowidth duration-200 z-20"
      :class="{
